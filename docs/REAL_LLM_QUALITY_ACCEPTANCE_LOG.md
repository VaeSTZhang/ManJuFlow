...
| 2026-05-04 | deepseek | deepseek-chat | film_script | film_script_safe_sample_001 | llm | pass | needs_prompt_fix | pass | LLM-QA-002 | Valid ShortDramaScriptOutput, but target_episode_count=3 was ignored and output compressed to 1 episode. | Safe fictional sample; output summary only. |
...
| LLM-QA-002 | deepseek | film_script | target_episode_count not strictly followed; requested 3 episodes but model returned 1 episode. | Do not paste full output. | medium | Strengthen film_script_to_short_drama_v1 prompt to preserve requested episode count unless explicitly impossible. | open |
